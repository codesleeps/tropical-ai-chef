  ...
  const features = [
    {
      ...
      description: "Get personalized juice recipes created by advanced AI that considers your taste preferences and health goals.",
      color: "text-secondary"
    },
    {
      icon: Leaf,
      title: "100% Natural Ingredients",
      description: "Only the freshest tropical fruits with no artificial additives, preservatives, or sweeteners.",
      color: "text-accent"
    },
    {
      icon: Heart,
      title: "Health-Focused Blends",
      description: "Every recipe is designed to maximize nutritional benefits while delivering incredible taste.",
      color: "text-primary"
    },
    {
      icon: Shield,
      title: "Quality Guaranteed",
      description: "Premium sourcing from sustainable farms with rigorous quality control standards.",
      color: "text-secondary"
    }
  ];
  ...
  const testimonials = [
    {
      ...
      location: "Miami, FL",
      rating: 5,
      comment: "The AI recipe generator is incredible! It created the perfect detox blend for my morning routine.",
      avatar: "👩‍💼"
    },
    {
      name: "Mike Chen",
      ...
      rating: 5,
      comment: "Fresh ingredients, amazing flavors, and the delivery is always on time. Highly recommended!",
      avatar: "👨‍💻"
    },
    {
      name: "Emma Rodriguez",
      ...
      rating: 5,
      comment: "Finally found healthy juices that actually taste amazing. The tropical blends are my favorite!",
      avatar: "👩‍🎨"
    }
  ];
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <Card key={index} className="shadow-tropical border-0 hover:scale-105 transition-bounce text-center">
                <CardHeader>
      ...
      <section className="py-20 px-6 bg-muted/30" id="how-it-works">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="shadow-tropical border-0 relative">
              ...
              <CardHeader className="text-center pt-8">
                ...
                <CardTitle className="text-xl text-primary">Choose Your Preferences</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-center">
                  Select your favorite fruits, dietary needs, and wellness goals. Our AI learns your unique taste profile.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="shadow-tropical border-0 relative">
              ...
              <CardHeader className="text-center pt-8">
                <div className="text-5xl mb-4">🧠</div>
                <CardTitle className="text-xl text-secondary">AI Creates Your Recipe</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-center">
                  Advanced algorithms analyze thousands of combinations to craft the perfect blend just for you.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="shadow-tropical border-0 relative">
              ...
              <CardHeader className="text-center pt-8">
                <div className="text-5xl mb-4">🥤</div>
                <CardTitle className="text-xl text-accent">Enjoy Fresh Delivery</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-center">
                  Get your personalized juices delivered fresh to your door, made with premium tropical fruits.
                </CardDescription>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="text-center mt-12">
            <Link to="/recipes">
              <Button size="lg" className="gradient-tropical text-foreground font-bold text-lg px-8 py-6 hover:scale-105 transition-bounce shadow-tropical">
      ...
      <section className="py-20 px-6 bg-gradient-to-br from-primary/20 via-secondary/10 to-accent/20" id="get-started">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-xl text-foreground/80 mb-8 max-w-2xl mx-auto">
            Create your first AI-powered tropical juice recipe today and discover flavors you never knew existed
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link to="/benefits">
              <Button size="lg" variant="outline" className="text-lg px-8 py-6 hover:scale-105 transition-bounce">
